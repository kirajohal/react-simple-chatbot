      ...
      <div className={`rsc ${className}`}>
        ...
        >
          ...
          <Footer className="rsc-footer" style={footerStyle}>
            <IDontKnowButton
              className="rsc-i-dont-know-button"
              style={iDontKnowButtonStyle}
              onClick={this.handleIDontKnowButton}
              hidden={disabled || !currentStep.iDontKnow}
            >
              {"I don't know"}
            </IDontKnowButton>
            <Input
...
ChatBot.propTypes = {
  ...
  iDontKnowButtonStyle: PropTypes.object,
